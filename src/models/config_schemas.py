...
class ConfigSetting(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Description of the configuration setting")
    group_name: Optional[str] = Field(None, description="Group this setting belongs to")
    created_at: Optional[datetime] = Field(None, description="When this setting was created")
    updated_at: Optional[datetime] = Field(None, description="When this setting was last updated")
...
class ConfigSettingsResponse(BaseModel):
    ...
    settings: List[ConfigSettingResponse] = Field(..., description="List of configuration settings")
